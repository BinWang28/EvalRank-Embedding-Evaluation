...
class BinaryClassifierEval(object):
    ...
    def run(self, params, batcher):
        ...
        logging.debug('Generating sentence embeddings')
        ...
        logging.debug('Generated sentence embeddings')
...
class SUBJEval(BinaryClassifierEval):
    def __init__(self, task_path, seed=1111):
        logging.info('Transfer task: SUBJ')
...
class MPQAEval(BinaryClassifierEval):
    def __init__(self, task_path, seed=1111):
        logging.info('Transfer task: MPQA')
